...
For details on the overall model architecture including MobileNetV2 backbone and SE attention, see [Model Architecture](./Model_Architecture.md#2.1). For data augmentation and pipeline implementation, see [Data Pipeline and Augmentation](./Data_Pipeline_and_Augmentation.md#2.3).
