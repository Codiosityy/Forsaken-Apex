...
For details on the underlying model architecture, see [Model Architecture](#2.1). For the progressive training methodology, see [Progressive Training Strategy](#2.2). For the production script version, see [Production Training Script (train.py)](#2.5).
