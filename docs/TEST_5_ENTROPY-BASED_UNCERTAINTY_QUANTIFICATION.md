...
For information about the current production training approach, see [Core Training System](#2). For evaluation methodology applied to these models, see [Model Evaluation Framework](#4).
