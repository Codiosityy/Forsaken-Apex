...
- Core training methodology using progressive resizing and focal loss: see [Core Training System](./Core_Training_System.md#2)
- Data preprocessing and augmentation pipeline: see [Data Preprocessing Pipeline](./Data_Pipeline_and_Augmentation.md#3)
- Comprehensive model validation framework: see [Model Evaluation Framework](./Model_Evaluation_Framework.md#4)
- Experimental training approaches: see [Alternative Training Approaches](./CNN-SVM_Ensemble_Approach_train1.py.md#5)
- Supporting utilities: see [Utility Tools](./Utility_Tools.md#6)
...
**Sources:** [kaggle-notebook.ipynb (evaluation section)](../kaggle-notebook.ipynb (evaluation section))
...
- **[Core Training System](./Core_Training_System.md#2)**: `ProgressiveTrainer`, `DataPipeline`, `FocalLoss`, `SEBlock` implementation details
- **[Data Preprocessing Pipeline](./Data_Pipeline_and_Augmentation.md#3)**: Dataset organization, grayscale conversion, metadata generation
- **[Model Evaluation Framework](./Model_Evaluation_Framework.md#4)**: 5-test validation suite, metrics calculation, report generation
- **[Alternative Training Approaches](./CNN-SVM_Ensemble_Approach_train1.py.md#5)**: Deprecated ensemble and two-phase training methods
- **[Utility Tools](./Utility_Tools.md#6)**: Supporting scripts for dataset inspection and file management
